      ...
      <div className="max-w-6xl mx-auto px-8 h-16 flex items-center justify-end">
        <div className="flex items-center gap-4">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-2 text-sm font-medium text-gray-300 hover:text-white transition-colors bg-kp-card border border-kp-border px-3 py-1.5"
          >
            <svg
              viewBox="0 0 24 24"
            ...
            Star on GitHub
            <span className="ml-2 pl-2 border-l border-kp-border text-gray-400">
              {stars}
            </span>
          </a>
        </div>
      ...
      <div className="min-h-screen bg-kp-bg text-white overflow-x-hidden relative flex flex-col">
        ...
        <div className="max-w-6xl mx-auto py-24 px-8 relative z-10 flex-1">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-kp-card/50 backdrop-blur-xl border border-kp-border p-8 hover:border-kp-accent/50 transition-colors">
              ...
              <div className="bg-[#0b1120] p-4 font-mono text-sm text-gray-300 border border-kp-border/50">
    ...
    <div className="min-h-screen bg-kp-bg text-white flex flex-col">
      ...
      <div className="max-w-5xl mx-auto p-8 flex-1 w-full">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-kp-card border border-kp-border p-6 h-fit shadow-lg">
            ...
            <ol className="space-y-4 text-sm text-gray-400 list-decimal list-inside">
              ...
              <li>
                Run{" "}
                <code className="bg-kp-bg border border-kp-border text-kp-accent font-mono px-1.5 py-0.5">
                  kp
                </code>
              </li>
